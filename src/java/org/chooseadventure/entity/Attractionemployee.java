...
@NamedQueries({
    ...
    @NamedQuery(name = "Attractionemployee.findByDateworking", query = "SELECT a FROM Attractionemployee a WHERE a.dateworking = :dateworking"),
...
public class Attractionemployee implements Serializable {
    ...
    public Attractionemployee(AttractionemployeePK attractionemployeePK, Date dateworking, BigInteger createdby, Date createdon, BigInteger modifiedby, Date modifiedon) {
        this.attractionemployeePK = attractionemployeePK;
