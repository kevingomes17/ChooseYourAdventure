...
@NamedQueries({
    ...
    @NamedQuery(name = "Employeerole.findByEmployeeIdRoleId", query = "SELECT e FROM Employeerole e WHERE e.employeerolePK.employeeid = :employeeid AND e.employeerolePK.roleid = :roleid"),
